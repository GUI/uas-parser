module.exports = { version: '20131025-01',
  robots: 
   { '3': 
      ...
      { userAgent: 'BUbiNG (+http://law.di.unimi.it/BUbiNG.html)',
        metadata: 
         { uaFamily: 'BUbiNG',
           ...
           uaCompany: ' Università degli studi di Milano.',
      ...
      { userAgent: 'MiaDev/0.0.1 (MIA Bot for research project MIA (www.MIA-marktplatz.de); http://www.mia-marktplatz.de/spider; spider@mia-marktplatz.de)',
        metadata: 
         { uaFamily: 'MiaDev',
           ...
           uaCompany: 'Technische Universität Berlin',
  ...
  osReg: 
   { '1': { regexp: /windows nt 5\.1/i, osId: '1' },
     ...
     '193': { regexp: /iPad[\s\S]*OS 7_[0-9_]+/i, osId: '129' },
  ...
  device: 
   { '1': 
     ...
     order: [ '1', '2', '3', '4', '5', '6', '7' ] },
  deviceReg: 
   { '1': { regexp: /iPad[\s\S]*OS[\s\S]*like Mac OS X/i, deviceId: '4' },
